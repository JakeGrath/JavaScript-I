...
// USING forEach//
let carModelsFe = [];
inventory.forEach(element => carModelsFe.push(element.car_model));
carModelsFe.sort();
console.log(carModelsFe);
...
//Using forEach//
let carYearsFe = [];
inventory.forEach(element => carYearsFe.push(element.car_year))
console.log(carYearsFe);
